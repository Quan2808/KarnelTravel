...
namespace WebApp.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression(@"^[a-zA-Z0-9\s]+$", ErrorMessage = "Only letters and numbers are allowed for the Address.")]
            public string Address { get; set; }

            [Required]
            [StringLength(255)]
            [Display(Name = "Username")]
            [RegularExpression(@"^[a-zA-Z0-9!@#$%^&*()-_=+`~\[\]{};:'"",.<>/?]+$", ErrorMessage = "Only letters, numbers, and special characters are allowed for the Username.")]
